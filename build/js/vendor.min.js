 ...
 *  License: MIT
 */
function(e,t,i){"use strict";var a,n,r;t.createElement("picture");var o={},s=!1,l=function(){},c=t.createElement("img"),u=c.getAttribute,f=c.setAttribute,d=c.removeAttribute,p=t.documentElement,h={},m={algorithm:""},v=navigator.userAgent,g=/rident/.test(v)||/ecko/.test(v)&&v.match(/rv\:(\d+)/)&&RegExp.$1>35,k="currentSrc",y=/\s+\+?\d+(e\d+)?w/,b=/(\([^)]+\))?\s*(.+)/,x=e.picturefillCFG,_="font-size:100%!important;",P=!0,E={},w={},S=e.devicePixelRatio,A={px:1,in:96},M=t.createElement("a"),T=!1,O=/^[ \t\n\r\u000c]+/,C=/^[, \t\n\r\u000c]+/,D=/^[^ \t\n\r\u000c]+/,B=/[,]+$/,R=/^\d+$/,j=/^-?(?:[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?$/,L=function(e,t,i,a){e.addEventListener?e.addEventListener(t,i,a||!1):e.attachEvent&&e.attachEvent("on"+t,i)},I=function(e){var t={};return function(i){return i in t||(t[i]=e(i)),t[i]}};function F(e){return" "===e||"\t"===e||"\n"===e||"\f"===e||"\r"===e}var N,V,G,H,z,U,K,q,$,Q,W,J,Y,Z,X,ee,te=(N=/^([\d\.]+)(em|vw|px)$/,V=I((function(e){return"return "+function(){for(var e=arguments,t=0,i=e[0];++t in e;)i=i.replace(e[t],e[++t]);return i}((e||"").toLowerCase(),/\band\b/g,"&&",/,/g,"||",/min-([a-z-\s]+):/g,"e.$1>=",/max-([a-z-\s]+):/g,"e.$1<=",/calc([^)]+)/g,"($1)",/(\d+[\.]*[\d]*)([a-z]+)/g,"($1 * e.$2)",/^(?!(e.[a-z]|[0-9\.&=|><\+\-\*\(\)\/])).*/gi,"")+";"})),function(e,t){var i;if(!(e in E))if(E[e]=!1,t&&(i=e.match(N)))E[e]=i[1]*A[i[2]];else try{E[e]=new Function("e",V(e))(A)}catch(e){}return E[e]}),ie=function(e,t){return e.w?(e.cWidth=o.calcListLength(t||"100vw"),e.res=e.w/e.cWidth):e.res=e.d,e},ae=function(e){if(s){var i,a,n,r=e||{};if(r.elements&&1===r.elements.nodeType&&("IMG"===r.elements.nodeName.toUpperCase()?r.elements=[r.elements]:(r.context=r.elements,r.elements=null)),n=(i=r.elements||o.qsa(r.context||t,r.reevaluate||r.reselect?o.sel:o.selShort)).length){for(o.setupRun(r),T=!0,a=0;a<n;a++)o.fillImg(i[a],r);o.teardownRun(r)}}};function ne(e,t){return e.res-t.res}function re(e,t){var i,a,n;if(e&&t)for(n=o.parseSet(t),e=o.makeUrl(e),i=0;i<n.length;i++)if(e===o.makeUrl(n[i].url)){a=n[i];break}return a}e.console&&console.warn,k in c||(k="src"),h["image/jpeg"]=!0,h["image/gif"]=!0,h["image/png"]=!0,h["image/svg+xml"]=t.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image","1.1"),o.ns=("pf"+(new Date).getTime()).substr(0,9),o.supSrcset="srcset"in c,o.supSizes="sizes"in c,o.supPicture=!!e.HTMLPictureElement,o.supSrcset&&o.supPicture&&!o.supSizes&&(G=t.createElement("img"),c.srcset="data:,a",G.src="data:,a",o.supSrcset=c.complete===G.complete,o.supPicture=o.supSrcset&&o.supPicture),o.supSrcset&&!o.supSizes?(H="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==",z=t.createElement("img"),U=function(){2===z.width&&(o.supSizes=!0),n=o.supSrcset&&!o.supSizes,s=!0,setTimeout(ae)},z.onload=U,z.onerror=U,z.setAttribute("sizes","9px"),z.srcset=H+" 1w,data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw== 9w",z.src=H):s=!0,o.selShort="picture>img,img[srcset]",o.sel=o.selShort,o.cfg=m,o.DPR=S||1,o.u=A,o.types=h,o.setSize=l,o.makeUrl=I((function(e){return M.href=e,M.href})),o.qsa=function(e,t){return"querySelector"in e?e.querySelectorAll(t):[]},o.matchesMedia=function(){return e.matchMedia&&(matchMedia("(min-width: 0.1em)")||{}).matches?o.matchesMedia=function(e){return!e||matchMedia(e).matches}:o.matchesMedia=o.mMQ,o.matchesMedia.apply(this,arguments)},o.mMQ=function(e){return!e||te(e)},o.calcLength=function(e){var t=te(e,!0)||!1;return t<0&&(t=!1),t},o.supportsType=function(e){return!e||h[e]},o.parseSize=I((function(e){var t=(e||"").match(b);return{media:t&&t[1],length:t&&t[2]}})),o.parseSet=function(e){return e.cands||(e.cands=function(e,t){function i(t){var i,a=t.exec(e.substring(c));if(a)return i=a[0],c+=i.length,i}var a,n,r,o,s,l=e.length,c=0,u=[];function f(){var e,i,r,o,s,l,c,f,d,p=!1,h={};for(o=0;o<n.length;o++)l=(s=n[o])[s.length-1],c=s.substring(0,s.length-1),f=parseInt(c,10),d=parseFloat(c),R.test(c)&&"w"===l?((e||i)&&(p=!0),0===f?p=!0:e=f):j.test(c)&&"x"===l?((e||i||r)&&(p=!0),d<0?p=!0:i=d):R.test(c)&&"h"===l?((r||i)&&(p=!0),0===f?p=!0:r=f):p=!0;p||(h.url=a,e&&(h.w=e),i&&(h.d=i),r&&(h.h=r),r||i||e||(h.d=1),1===h.d&&(t.has1x=!0),h.set=t,u.push(h))}function d(){for(i(O),r="",o="in descriptor";;){if(s=e.charAt(c),"in descriptor"===o)if(F(s))r&&(n.push(r),r="",o="after descriptor");else{if(","===s)return c+=1,r&&n.push(r),void f();if("("===s)r+=s,o="in parens";else{if(""===s)return r&&n.push(r),void f();r+=s}}else if("in parens"===o)if(")"===s)r+=s,o="in descriptor";else{if(""===s)return n.push(r),void f();r+=s}else if("after descriptor"===o)if(F(s));else{if(""===s)return void f();o="in descriptor",c-=1}c+=1}}for(;;){if(i(C),c>=l)return u;a=i(D),n=[],","===a.slice(-1)?(a=a.replace(B,""),f()):d()}}(e.srcset,e)),e.cands},o.getEmValue=function(){var e;if(!a&&(e=t.body)){var i=t.createElement("div"),n=p.style.cssText,r=e.style.cssText;i.style.cssText="position:absolute;left:0;visibility:hidden;display:block;padding:0;border:none;font-size:1em;width:1em;overflow:hidden;clip:rect(0px, 0px, 0px, 0px)",p.style.cssText=_,e.style.cssText=_,e.appendChild(i),a=i.offsetWidth,e.removeChild(i),a=parseFloat(a,10),p.style.cssText=n,e.style.cssText=r}return a||16},o.calcListLength=function(e){if(!(e in w)||m.uT){var t=o.calcLength(function(e){var t,i,a,n,r,s,l,c=/^(?:[+-]?[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?(?:ch|cm|em|ex|in|mm|pc|pt|px|rem|vh|vmin|vmax|vw)$/i,u=/^calc\((?:[0-9a-z \.\+\-\*\/\(\)]+)\)$/i;for(a=(i=function(e){var t,i="",a=[],n=[],r=0,o=0,s=!1;function l(){i&&(a.push(i),i="")}function c(){a[0]&&(n.push(a),a=[])}for(;;){if(""===(t=e.charAt(o)))return l(),c(),n;if(s){if("*"===t&&"/"===e[o+1]){s=!1,o+=2,l();continue}o+=1}else{if(F(t)){if(e.charAt(o-1)&&F(e.charAt(o-1))||!i){o+=1;continue}if(0===r){l(),o+=1;continue}t=" "}else if("("===t)r+=1;else if(")"===t)r-=1;else{if(","===t){l(),c(),o+=1;continue}if("/"===t&&"*"===e.charAt(o+1)){s=!0,o+=2;continue}}i+=t,o+=1}}}(e)).length,t=0;t<a;t++)if(r=(n=i[t])[n.length-1],l=r,c.test(l)&&parseFloat(l)>=0||u.test(l)||"0"===l||"-0"===l||"+0"===l){if(s=r,n.pop(),0===n.length)return s;if(n=n.join(" "),o.matchesMedia(n))return s}return"100vw"}(e));w[e]=t||A.width}return w[e]},o.setRes=function(e){var t;if(e)for(var i=0,a=(t=o.parseSet(e)).length;i<a;i++)ie(t[i],e.sizes);return t},o.setRes.res=ie,o.applySetCandidate=function(e,t){if(e.length){var i,a,n,r,s,l,c,u,f,d,p,h,v,y,b,x,_=t[o.ns],P=o.DPR;if(l=_.curSrc||t[k],(c=_.curCan||function(e,t,i){var a;return!i&&t&&(i=(i=e[o.ns].sets)&&i[i.length-1]),(a=re(t,i))&&(t=o.makeUrl(t),e[o.ns].curSrc=t,e[o.ns].curCan=a,a.res||ie(a,a.set.sizes)),a}(t,l,e[0].set))&&c.set===e[0].set&&((f=g&&!t.complete&&c.res-.1>P)||(c.cached=!0,c.res>=P&&(s=c))),!s)for(e.sort(ne),s=e[(r=e.length)-1],a=0;a<r;a++)if((i=e[a]).res>=P){s=e[n=a-1]&&(f||l!==o.makeUrl(i.url))&&(d=e[n].res,p=i.res,h=P,v=e[n].cached,y=void 0,b=void 0,x=void 0,"saveData"===m.algorithm?d>2.7?x=h+1:(b=(p-h)*(y=Math.pow(d-.6,1.5)),v&&(b+=.1*y),x=d+b):x=h>1?Math.sqrt(d*p):d,x>h)?e[n]:i;break}s&&(u=o.makeUrl(s.url),_.curSrc=u,_.curCan=s,u!==l&&o.setSrc(t,s),o.setSize(t))}},o.setSrc=function(e,t){var i;e.src=t.url,"image/svg+xml"===t.set.type&&(i=e.style.width,e.style.width=e.offsetWidth+1+"px",e.offsetWidth+1&&(e.style.width=i))},o.getSet=function(e){var t,i,a,n=!1,r=e[o.ns].sets;for(t=0;t<r.length&&!n;t++)if((i=r[t]).srcset&&o.matchesMedia(i.media)&&(a=o.supportsType(i.type))){"pending"===a&&(i=a),n=i;break}return n},o.parseSets=function(e,t,i){var a,r,s,l,c=t&&"PICTURE"===t.nodeName.toUpperCase(),p=e[o.ns];(undefined===p.src||i.src)&&(p.src=u.call(e,"src"),p.src?f.call(e,"data-pfsrc",p.src):d.call(e,"data-pfsrc")),(undefined===p.srcset||i.srcset||!o.supSrcset||e.srcset)&&(a=u.call(e,"srcset"),p.srcset=a,l=!0),p.sets=[],c&&(p.pic=!0,function(e,t){var i,a,n,r,s=e.getElementsByTagName("source");for(i=0,a=s.length;i<a;i++)(n=s[i])[o.ns]=!0,(r=n.getAttribute("srcset"))&&t.push({srcset:r,media:n.getAttribute("media"),type:n.getAttribute("type"),sizes:n.getAttribute("sizes")})}(t,p.sets)),p.srcset?(r={srcset:p.srcset,sizes:u.call(e,"sizes")},p.sets.push(r),(s=(n||p.src)&&y.test(p.srcset||""))||!p.src||re(p.src,r)||r.has1x||(r.srcset+=", "+p.src,r.cands.push({url:p.src,d:1,set:r}))):p.src&&p.sets.push({srcset:p.src,sizes:null}),p.curCan=null,p.curSrc=undefined,p.supported=!(c||r&&!o.supSrcset||s&&!o.supSizes),l&&o.supSrcset&&!p.supported&&(a?(f.call(e,"data-pfsrcset",a),e.srcset=""):d.call(e,"data-pfsrcset")),p.supported&&!p.srcset&&(!p.src&&e.src||e.src!==o.makeUrl(p.src))&&(null===p.src?e.removeAttribute("src"):e.src=p.src),p.parsed=!0},o.fillImg=function(e,t){var i,a=t.reselect||t.reevaluate;e[o.ns]||(e[o.ns]={}),i=e[o.ns],(a||i.evaled!==r)&&(i.parsed&&!t.reevaluate||o.parseSets(e,e.parentNode,t),i.supported?i.evaled=r:function(e){var t,i=o.getSet(e),a=!1;"pending"!==i&&(a=r,i&&(t=o.setRes(i),o.applySetCandidate(t,e))),e[o.ns].evaled=a}(e))},o.setupRun=function(){T&&!P&&S===e.devicePixelRatio||(P=!1,S=e.devicePixelRatio,E={},w={},o.DPR=S||1,A.width=Math.max(e.innerWidth||0,p.clientWidth),A.height=Math.max(e.innerHeight||0,p.clientHeight),A.vw=A.width/100,A.vh=A.height/100,r=[A.height,A.width,S].join("-"),A.em=o.getEmValue(),A.rem=A.em)},o.supPicture?(ae=l,o.fillImg=l):(Y=e.attachEvent?/d$|^c/:/d$|^c|^i/,Z=function(){var e=t.readyState||"";X=setTimeout(Z,"loading"===e?200:999),t.body&&(o.fillImgs(),(K=K||Y.test(e))&&clearTimeout(X))},X=setTimeout(Z,t.body?9:99),ee=p.clientHeight,L(e,"resize",(q=function(){P=Math.max(e.innerWidth||0,p.clientWidth)!==A.width||p.clientHeight!==ee,ee=p.clientHeight,P&&o.fillImgs()},$=99,J=function(){var e=new Date-W;e<$?Q=setTimeout(J,$-e):(Q=null,q())},function(){W=new Date,Q||(Q=setTimeout(J,$))})),L(t,"readystatechange",Z)),o.picturefill=ae,o.fillImgs=ae,o.teardownRun=l,ae._=o,e.picturefillCFG={pf:o,push:function(e){var t=e.shift();"function"==typeof o[t]?o[t].apply(o,e):(m[t]=e[0],T&&o.fillImgs({reselect:!0}))}};for(;x&&x.length;)e.picturefillCFG.push(x.shift());e.picturefill=ae,"object"==typeof module&&"object"==typeof module.exports?module.exports=ae:"function"==typeof define&&define.amd&&define("picturefill",(function(){return ae})),o.supPicture||(h["image/webp"]=function(t,i){var a=new e.Image;return a.onerror=function(){h[t]=!1,ae()},a.onload=function(){h[t]=1===a.width,ae()},a.src=i,"pending"}("image/webp","data:image/webp;base64,UklGRkoAAABXRUJQVlA4WAoAAAAQAAAAAAAAAAAAQUxQSAwAAAABBxAR/Q9ERP8DAABWUDggGAAAADABAJ0BKgEAAQADADQlpAADcAD++/1QAA=="))}(window,document);